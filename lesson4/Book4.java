...
public class Book
{
    ...
    public String getSecondSentence()
    {
        ...
        // the second period
        int startOfSentence = bookText.indexOf(".") + 1;
        int endOfSentence = bookText.substring(startOfSentence).indexOf(".") + startOfSentence;
        return bookText.substring(startOfSentence, endOfSentence + 1);
    }
