...
public class Robot
{
    ...
    public Robot(int theX, int theY)
    {
        ...
        initialLocation = new Point(theX, theY);
        currentLocation = new Point(theX, theY);
    ...
    public double getDistanceFromStart() {
        double width = currentLocation.getX() - initialLocation.getX();
        double height = currentLocation.getY() - initialLocation.getY();
    ...
    public void makeRandomMove() {
        ...
        else if (direction == 1) ++y; // south
        else if (direction == 2) ++x; // east
