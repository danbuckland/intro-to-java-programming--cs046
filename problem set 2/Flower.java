...
public class Flower
{
    ...
    */
    public void draw()
    {
        Ellipse pink1   = new Ellipse(x + 20, y,    20, 20);
        Ellipse pink2   = new Ellipse(x,      y + 20, 20, 20);
        Ellipse yellow3 = new Ellipse(x + 20, y + 20, 20, 20);
        Ellipse pink4   = new Ellipse(x + 40, y + 20, 20, 20);
        Ellipse pink5   = new Ellipse(x + 20, y + 40, 20, 20);
        Line line1      = new    Line(x + 30, y + 60, x+30, y+120);
        pink1.setColor(Color.PINK);
        pink2.setColor(Color.PINK);
        yellow3.setColor(Color.YELLOW);
        pink4.setColor(Color.PINK);
        pink5.setColor(Color.PINK);
