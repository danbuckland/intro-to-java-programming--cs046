...
public class GradeBook
{
    ...
    public String teacherCommentForStudent(int studentIndex)
    {
        ...
        result = "Hi " + studentName + ", here are your results" + "\n";
        for (int topic = 0; topic < numTopics; ++topic) {
            String topicName = topics.get(topic);
            double score = grades[studentIndex][topic];
            result += topicName + ": " + score;
            if (score < 3) result += ", you should really improve on this!!!" + "\n";
            else if (score < 6) result += ", try better!" + "\n";
            else if (score < 8) result += ", nice!" + "\n";
            else if (score < 9) result += ", good!" + "\n";
            else if (score < 10) result += ", excelent!!" + "\n";
            else result += ", WOW!!" + "\n";
        }
